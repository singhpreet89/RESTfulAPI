...
class TransactionTransformer extends TransformerAbstract
{
    ...
    public function transform(Transaction $transaction)
    {
        return [
            ...
            'deletedDate' => isset($transaction->deleted_at) ? (string) $transaction->deleted_at : null, // Since this can be null

            // HATEOAS, to provide further navigation links (HYPERMEDIA CONTROLS)
            'links' => [
                [
                    'rel' => 'self',
